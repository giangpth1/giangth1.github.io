...
<div class="container toparea">
	<div class="underlined-title">
		<div class="editContent">
			<h1 class="text-center latestitems">Đăng nhập</h1>
		</div>
	...
	<div class="row">
		<div class="col-lg-8 col-lg-offset-2">
			...
			<form method="post" action="contact.php" id="contactform">
				<div class="form">
					Tên tài khoản: <input type="text" name="name" placeholder="Nhập tên tài khoản">
					Mật khẩu: <input type="password" name="password" placeholder="Nhập mật khẩu">
					<input type="submit" id="submit" class="clearfix btn" value="Đăng nhập">
				</div>
			</form>
		</div>
	</div>
