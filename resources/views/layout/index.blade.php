	...
	<div class="container">
		...
		<div id="navbar-collapse-02" class="collapse navbar-collapse">
			<ul class="nav navbar-nav navbar-right">
				<li class="propClone"><a href="{{route('index')}}">Home</a></li>
				...
				<li class="propClone"><a href="{{route('login')}}">Đăng nhập</a></li>
				<li class="propClone"><a href="{{route('register')}}">Đăng ký</a></li>
			</ul>
		</div>
	</div>
	</nav>
